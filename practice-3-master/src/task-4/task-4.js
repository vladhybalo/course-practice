...
export default class ShoppingCart {
    ...
    addEventListeners() {
        ...
        this.cartEl.addEventListener("click",this.getItemId.bind(this));
    }

    getItemId(item) {
        this.removeItem(item.target.dataset.itemId);
    }
    ...
    removeItem(item) {
        // йдем по корзині
        for (let elem of this.cartEl.children) {   
